...
export default function CreditCardWidget() {
  return (
    <div className="p-6 w-full rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-border shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
